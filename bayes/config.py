...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--data_path', help='data_path', default='~/Projects/data/iccad19/iccad_2019_dct')
        ...
        parser.add_argument('--save_dir', default='~/Projects/bayes_darts/searchs', help='save_dir')
...
class AugmentConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--save_path', default='', help='save_path')
        parser.add_argument('--save_dir', default='~/Projects/bayes_darts/augments', help='save_dir')
