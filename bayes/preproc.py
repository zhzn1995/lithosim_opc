...
def data_transforms(dataset, cutout_length, inputsize):
    ...
    if dataset == 'cifar10':
        ...
        transf = [
            np_transforms.RandomCrop(inputsize, padding=4),
    ...
    if dataset == 'iccad19':
        ...
        valid_transform = transforms.Compose([np_transforms.ToTensor()])
