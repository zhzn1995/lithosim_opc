...
def get_rec_iter(args, kv=None):
    ...
    val = mx.io.ImageRecordIter(
        ...
        part_index          = rank)
    return (train, val)
def prepair_data_hotspot(args, kv=None):
    train_iter = mx.image.ImageIter(
        path_imgrec="data/128x128/train_bias0.00.rec",
        path_imgidx="data/128x128/train_bias0.00.idx",
    ...
    val_iter = mx.image.ImageIter(
        path_imgrec="data/128x128/val_bias0.00.rec",
        data_shape=(3,128,128),
        batch_size=47,
        preprocess_threads=4,
        label_width=2,
